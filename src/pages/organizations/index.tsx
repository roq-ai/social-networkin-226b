...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'advertisement.count', 'post.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('advertisement', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'advertisement',
          header: 'Advertisement',
          accessorKey: 'advertisement',
          cell: ({ row: { original: record } }: any) => record?._count?.advertisement,
        }
      : null,
